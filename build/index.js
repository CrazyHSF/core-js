...
(function(){
  var Promise, ref$, list, experimental, libraryBlacklist, banner, readFile, writeFile, unlink, basename, dirname, join, webpack, temp;
  Promise = require('../library/fn/promise');
  ref$ = require('./config'), list = ref$.list, experimental = ref$.experimental, libraryBlacklist = ref$.libraryBlacklist, banner = ref$.banner;
  ...
  module.exports = function(arg$){
    ...
    return new Promise(function(resolve, reject){
      (function(){
        var i$, x$, ref$, len$, ns, name, j$, len1$, TARGET, this$ = this;
        if (this.exp) {
